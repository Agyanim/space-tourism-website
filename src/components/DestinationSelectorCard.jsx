...
const normal="destination-lbl tracking-[0.2rem]"
  ...
  return (
    <div className='md:relative translate-y-[11.5rem] md:translate-y-0 md:top-0 flex justify-center md:justify-start gap-7 w-[70%] m-auto md:gap-5 lg:w-1/4 lg:ml-[59.5%]'>
        <div>
