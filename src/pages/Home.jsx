  ...
  return (
    <>
      <div className=" home-container absolute w-[100svw] h-screen">
        <section className="flex  justify-center items-center w-full relative mt-[23rem] lg:mt-[29rem]">
          <div className="flex flex-col gap-[2rem] lg:gap-[5rem] lg:flex-row text-white absolute w-[100%] lg:w-[80%] justify-between items-center pb-[5%] top-[-18rem]">
            <section className="flex flex-col justify-center items-center mb-[5rem] lg:items-start lg:justify-start w-[95%]  lg:w-[62%] xl:w-[40%] p-2 mt-4 ">
            ...
            <section className="-mb-24 lg:w-[38%] xl:w-[50%]  flex justify-center items-center">
              <div
